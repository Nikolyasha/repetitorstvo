...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Следующая",sPrevious:"Назад"},sEmptyTable:"No data available in table",sInfo:"Показано _START_-_END_ из _TOTAL_ записей",sInfoEmpty:"Показано 0-0 из 0 записей",sInfoFiltered:"(filtered from _MAX_ total записей)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать _MENU_ записей",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},
