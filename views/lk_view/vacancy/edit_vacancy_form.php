                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <form method="POST" action="./vacancies.php">
                            <input type="hidden" name="vacancy_company_id" value="<? echo($company_id); ?>"/>
                            <input type="hidden" name="token" value="<?=$_SESSION['token']?>"/>
                            <input type="hidden" name="action" value="edit"/>
                            <input type="hidden" name="post_id" value="<? echo($_GET['edit']); ?>"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input value="<? echo(($vacancy['salary_per_hour'] != 0 ? $vacancy['salary_per_hour'] : "")); ?>" name="vacancy_salary_per_hour" type="number" class="form-control" placeholder="0" max="1000000">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Оплата за день</label>
                                <div class="col-sm-10">
                                    <input value="<? echo(($vacancy['salary_per_day'] != 0 ? $vacancy['salary_per_day'] : "")); ?>" name="vacancy_salary_per_day" type="number" class="form-control" placeholder="0" max="1000000">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Оплата за месяц</label>
                                <div class="col-sm-10">
                                    <input value="<? echo(($vacancy['salary_per_month'] != 0 ? $vacancy['salary_per_month'] : "")); ?>" name="vacancy_salary_per_month" type="number" class="form-control" placeholder="0" max="1000000">
                                </div>
                            </div>
                            <div class="form-group row">
                                                ...
                                                case 0: 
                                                    if (count($optArr) > 2) {?>
                                                        <div class="col-sm-10 border-checkbox-section element-margin">                                                            
                                                            ...
                                                            <div class="border-checkbox-group border-checkbox-group-primary">
                                                                <div class="border-checkbox-group border-checkbox-group-primary">
                                                                    <input class="border-checkbox" type="checkbox" id="extra_<? echo $field['name']; ?>_<?echo $i;?>" name="extra_<? echo $field['name']; ?>_<?echo $i;?>" <? if($multipleCheckBox[$option] == 1) echo("checked") ?>>
...
<script type="text/javascript" src="../bower_components/modernizr/js/modernizr.js"></script>
    ...
    <script>
        ...
        another();
        $(document).ready(() => { createVacancyDurationChangeHandler(); });
