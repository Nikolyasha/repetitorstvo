        ...
        <div class="pcoded-inner-content">
            <div class="main-body">
                ...
                <div class="card-header">
                    <h5>Отклики на вакансию «<? echo($vacancy['name']); ?>» (<a target="blank" href="/vacancy/<? echo($_GET['view']); ?>">#ID<? echo($_GET['view']); ?></a>)</h5>
                            ...
                            for ($i = 0; $i < count($responses); $i++) {
                                ...
                                <tr id="offer_'.$item['id'].'">
                                    ...
                                    <td class="action_column">
                                        <a target="blank" href="/anket/'.$item['user_id'].'"><button class="btn btn-info btn-icon">
                                        ...
                                        '.(
                                            $item['status'] != 0 ?
                                                ...
                                                <a  onclick="removeOffer('.$item['id'].', '.$vacancy['id'].');"><button class="btn btn-danger btn-icon">
                                                    <i class="icofont icofont-ui-delete"></i>
                                                </button></a>' :
                                                '<a  href="offers.php?reply='.$item['id'].'&vacancy='.$vacancy['id'].'&redirect=vacancies.php?view='.$vacancy['id'].'"><button class="btn btn-success btn-icon">
                                                    <i class="icofont icofont-reply"></i>
                                                </button></a>
                                                <a  onclick="rejectOffer('.$item['id'].', '.$vacancy['id'].');"><button class="btn btn-danger btn-icon">
