                    ...
                    <div class="vakancy__row__title">
                        <div class="vakancy__main">
                            ...
                            <div class="vakancy__buttons-container">
                                ...
                                <div class="vakancy__button-reset">
                                    <a href="." class="vak__button">cбросить фильтры</a>
                                </div>
                            </div>
                        ...
                        <div class="text__left">
                            ...
                            <? }
                                ...
                                foreach ($vacancies as $key=>$item) {
                                    $class = ($key === 0) ? 'first' : (($key === count($vacancies) - 1) ? 'last' : '');
                                            ...
                                            '.($_SESSION['account_type'] != 2 ? '
                                                <div class="wrap__footer--buttons">
                                                    <div class="last__button">
                                                        <a href="/lk/send_offer.php?vacancy='.$item['id'].'" class="but__p">откликнуться</a>
                                                    </div>' : '' ).'
